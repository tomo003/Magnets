...
namespace basecross {
	...
	void Guide::OnCreate()
	{
		...
		m_vertices = {
			...
			{Vec3(-1.5f, +1.5f, 0.0f), Vec2(0.0f, 0.0f)}, // 左上:0
			{Vec3(+1.5f, +1.5f, 0.0f), Vec2(1.0f, 0.0f)}, // 右上:1
			{Vec3(-1.5f, -1.5f, 0.0f), Vec2(0.0f, 1.0f)}, // 左下:2
			{Vec3(+1.5f, -1.5f, 0.0f), Vec2(1.0f, 1.0f)}, // 右下:3
		};
